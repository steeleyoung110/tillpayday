    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-slate-950 p-6">
      <div className="w-full max-w-sm">
        ...
        <form className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900 p-6">
          ...
          <label className="flex items-start gap-2 pt-2 text-xs text-slate-400">
            <input
              type="checkbox"
              name="legal_ack"
            ...
            />
            <span>
              For sign-up: I understand Till Payday is an educational tool that
              shows math on numbers I enter — not financial advice.{" "}
              <a
                href="/legal"
