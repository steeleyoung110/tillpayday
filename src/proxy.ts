...
export const config = {
  matcher: [
     ...
     */
    "/((?!_next/static|_next/image|favicon.ico|manifest.webmanifest|sw.js|offline.html|icons/|apple-icon.png|api/nudges|api/calendar|demo|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)",
  ],
};
